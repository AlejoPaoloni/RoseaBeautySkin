          ...
          {producto.imagen_url && (
            <>
              ...
              <Image
                ...
                // contain y no cover: la foto se ve entera, como la
                // subio la duena, en vez de recortada para llenar la card.
                className={`object-contain transition-[opacity,transform] duration-700 ease-out ${
